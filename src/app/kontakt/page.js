          ...
          <div className="container mx-auto px-4 py-20 relative z-10">
            <div className="max-w-3xl">
              ...
              <p className="text-xl mb-8 text-blue-100">
                Imate pitanja o uvozu automobila? Naš tim je tu da vam pomogne.
                Kontaktirajte nas putem telefona, e-maila ili nas posetite u
                našoj kancelariji.
              </p>
            </div>
          </div>
          ...
          <div className="container mx-auto px-4">
            <div className="text-center mb-12">
              ...
              <p className="text-xl text-gray-600 max-w-3xl mx-auto">
                Posetite nas na našoj adresi u Beogradu
              </p>
            </div>
        ...
        <section className="py-16 bg-blue-700 text-white">
          <div className="container mx-auto px-4 text-center">
            ...
            <p className="text-xl text-blue-100 max-w-3xl mx-auto mb-8">
              Pošaljite zahtev za uvoz i započnite proces pronalaženja vašeg
              idealnog automobila
            </p>
